...
function lum_setup() {
	...
	register_nav_menus ( array (
		'primary-menu' => __( 'Primary Menu', 'LuM' ),
		'secondary' => __( 'Secondary Menu', 'LuM' ),  
	) );
}
...
function lum_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar 1', 'LuM' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'LuM' ),
...
add_action( 'widgets_init', 'lum_widgets_init' );

// defines custom markup for post comments
function lum_comments($comment, $args, $depth) {
